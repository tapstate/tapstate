...
/** Structured editor layout projection kept separate from the persisted store model. */
public record PipelineLayoutView(
        String pipelineId, Map<String, NodePosition> nodes, Viewport viewport) {

    public PipelineLayoutView {
