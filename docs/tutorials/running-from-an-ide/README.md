...
| Environment variables | `TAPSTATE_STORE_MONGO_URI=mongodb://localhost:27117/tapstate?directConnection=true;TAPSTATE_STORE_MONGO_OPERATOR_STATE_DATABASE=tapstate_dev_nest` |
